...
$$
    ...
    BEGIN
        ...
        VALUES (minion1, 1, 'Aco', 2, evil_master_id, '{"apperance":{"Hair":"none","Eyes":"2"},"personality":{"Hair":"none","Eyes":"2"}}');
        insert into minion(id, version, name, number_of_eyes, evil_master, description)
        VALUES (uuid_generate_v4(), 1, 'Maco', 1, evil_master_id, '{"apperance":{"Hair":"none","Eyes":"2"},"personality":{"Hair":"none","Eyes":"2"}}');
        insert into minion(id, version, name, number_of_eyes, evil_master, description)
        VALUES (uuid_generate_v4(), 1, 'Kaco', 2, evil_master_id, '{"apperance":{"Hair":"none","Eyes":"2"},"personality":{"Hair":"none","Eyes":"2"}}');
